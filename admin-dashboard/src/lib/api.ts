...
export function resolveReviewCase(reviewId: string, notes: string): Promise<void> {
...
export function rejectReviewCase(reviewId: string, notes: string): Promise<void> {
...
export function testEventSink(sinkId: string): Promise<void> {
